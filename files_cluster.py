nguage_path = '../paccmann_affinity/trained_models/vae_selfies_one_hot_mod'
mol_model_path = '../paccmann_affinity/trained_models/vae_selfies_one_hot'
omics_model_path = '../pvae'
protein_model_path = '../paccmann_affinity/trained_models/pevae_avg'
ic50_model_path = '../paccmann_003'
affinity_model_path = '../paccmann_affinity/trained_models/base_affinity'
omics_data_path = '../data/gdsc_transcriptomics_for_conditional_generation.pkl'
protein_data_path = '../embedding.csv'#paccmann_affinity/sars_cov2_data/tape/transformer/avg.csv'
...
params_path = 'examples/IC50/example_params.json'
model_name = 'neuroblastoma_test2'
site = 'all'
